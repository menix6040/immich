...
import 'package:immich_mobile/widgets/settings/preference_settings/memory_music_setting.dart';
...
class PreferenceSetting extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const preferenceSettings = [ThemeSetting(), HapticSetting(), MemoryMusicSetting()];
